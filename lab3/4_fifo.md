...
我们通过`_fifo_check_swap()`, `check_swap()`, `check_vma_struct()`, `check_pgfault()`等接口对页面置换机制进行了简单的测试。具体测试的细节这里地方太小了，写不下。

目前的参考代码可以在[这里](https://github.com/Liurunda/riscv64-ucore/tree/lab3/lab3)找到。